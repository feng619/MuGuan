...
echo "
				...
				<div class='s34_2box'>
					<p class='album_name'>何季耕蛾類觀察記錄</p>
				...
				<div class='s34_2box'>
					<p class='album_name'>阿里山青年活動中心</p>
